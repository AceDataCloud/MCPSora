package com.acedatacloud.mcp.sora
...
class McpSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "Sora MCP"
    ...
    override fun createComponent(): JComponent {
        ...
        myPanel = panel {
            ...
            group("Links") {
                ...
                row {
                    browserLink("Source Code", "https://github.com/AceDataCloud/MCPSora")
                }
                row {
                    browserLink("PyPI Package", "https://pypi.org/project/mcp-sora/")
                }
            }
        }
